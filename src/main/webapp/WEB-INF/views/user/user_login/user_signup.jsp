			 ...
			 function knameCheck(args) {
		      ...
		      function birthCheck(args) {
				...
				$("#dupId").click(function(){
					window.open("sign_id_dup.do","id_dup","width=500,height=400");	
			});

	
			$("#dupEmail").click(function(){
				window.open("sign_email_dup.do","email_dup","width=500,height=400");	
		});
	});//ready
...
<form action="user_signup_result.do" method="post" name="frm" id="frm">
...
<br/><br/><br/><hr class="hr1"><br/><br/>
	...
	<tr style = "height: 80px; vertical-align: top;">
		<td style="padding-right: 5px;padding-left: 5px;">
			<input type="text" class="form-control" name="id" id="id" placeholder="아이디를 입력하세요" readonly="readonly">
		</td>
		<td>&nbsp;&nbsp;&nbsp;
			<input type="button" value="중복확인"  id="dupId">
		</td>
	</tr>
	<tr>
	...
	<tr style = "height: 80px; vertical-align: top;">
		<td  style="padding-right: 5px;padding-left: 5px;">
			<input type="text" class="form-control" name="email"  id="email" placeholder="이메일을 입력하세요"readonly="readonly">
		</td>
	<td style = "width: 110px; ">&nbsp;&nbsp;&nbsp;
		<input type="button" value="중복확인" id="dupEmail" > 
	</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type="password" class="form-control"  name="pass1" id="pass1" placeholder="한번 더 입력하세요"> <br/><br/>
		</td>
	</tr>
	<tr>
